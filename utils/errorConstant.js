...
export const NotFound = (name, description) => {
  return errorProperties(
    ApplicationError.prepare("NotFoundException", {
      code: `${name}-not-found`,
...
export const NotSaved = (name, description) => {
  return errorProperties(
    ApplicationError.prepare("NotSavedException", {
...
export const NotValid = (name, description) => {
  return errorProperties(
    ApplicationError.prepare("NotValidException", {
      code: `${name}-not-valid`,
      message: description,
    })
  );
...
export const AuthenticationFailed = (msg) => {
  return errorProperties(
    ApplicationError.prepare("UnauthorizedException", {
...
export const AlreadyExists = (name, description) => {
  return errorProperties(
    ApplicationError.prepare("ConflictException", {
      code: `Already Exists`,
...
export const FileLimit = (name, description) => {
  return errorProperties(
    ApplicationError.prepare("TooLargeException", {
      code: `${name}-toolarge`,
...
export const SomethingWentWrong = (
  ...
  return errorProperties(
    ApplicationError.prepare("ServerException", {
...
export const CustomError = (description) => {
  return errorProperties(
    ApplicationError.prepare("ClientException", {
